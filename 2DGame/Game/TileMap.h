...
public:
	...
	bool collisionMoveDown(const glm::ivec2 &pos, const glm::ivec2 &size, int *posY, int fallStep, int margin);
	bool collisionMoveDownSimple(const glm::ivec2& pos, const glm::ivec2& size, int margin);
