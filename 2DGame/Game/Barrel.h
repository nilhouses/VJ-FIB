...
private:
	glm::vec2 prevPos;			        // Para trackear ca�das(y) y movimiento(x) del peso
	...
	float targetX;						// Donde llega el peso con el �ltimo empuje
	bool isBeingPushed;					// Si el peso est� siendo empujado
	int pushDirection;					// 1 derecha, -1 izquierda
	float fallSpeed;				    // Para controlar la velocidad de ca�da del peso, ahora que hay aceleraci�n
};
