...
public:
	...
	void init(const glm::ivec2& tileMapPos, const string& levelPath, const string& entityPath, const string& assetPath);
...
private:
    ...
    void createEntity(const glm::ivec2& tileMapPos, const string& type, int tileX, int tileY, int roomTo); // Crea una entidad del tipo dado en la posición dada (en tiles)
