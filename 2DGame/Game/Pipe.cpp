...
// Coordenadas de textura de cada tile del spritesheet pipe.png, (En funci�n de donde tiene los agujeros)
#define NRows 3
#define NCols 7
...
// ------------------------------------------------------- L�gica para saber qu� textura tiene cada segmento -------------------------------------------------------
...
glm::vec2 Pipe::busyTexCoords(const glm::vec2& idleTexCoords) const
{
    ...
    return idleTexCoords; // Los dem�s segmentos no cambian
}
...
bool Pipe::getEntryKey(int end) const
{
    ...
    // La direcci�n hacia el interior del tubo
...
// Override
glm::vec4 Pipe::getBoundingBox() const // Cubre ambos extremos de la tuber�a
{
